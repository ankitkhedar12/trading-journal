...
import SetupVantageAccountDialog from './SetupVantageAccountDialog';

const MotionPaper = motion(Paper);

interface VantageSetupCenterProps {
    openSetup: boolean;
...
const VantageSetupCenter: React.FC<VantageSetupCenterProps> = ({
    openSetup,
    setOpenSetup,
    accountName,
    setAccountName,
        ...
        <Box sx={{ 
            ...
            >
                ...
                <Typography variant="h3" gutterBottom fontWeight="900" sx={{ 
                    ...
                    Vantage Account Tracker
                </Typography>
                
                <Typography variant="body1" color="text.secondary" sx={{ mb: 6, maxWidth: '450px', fontSize: '1.1rem', lineHeight: 1.7 }}>
                    Track your Vantage trading performance, balance growth, win streaks, and detailed insights. Set up an account to import your trade history.
                </Typography>
...
export default VantageSetupCenter;
