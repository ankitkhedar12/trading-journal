    ...
    async sendSignupVerificationCode(toEmail: string, code: string): Promise<void> {
        ...
        <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 480px; margin: 0 auto; padding: 40px 24px; background: linear-gradient(135deg, #0f172a, #1e293b); border-radius: 16px; color: #f8fafc;">
            <div style="text-align: center; margin-bottom: 32px;">
                ...
                <p style="color: #94a3b8; margin-top: 8px; font-size: 14px;">Welcome to the Elite Trading Circle</p>
            </div>
            <div style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; padding: 24px; text-align: center; margin-bottom: 24px;">
                <p style="color: #cbd5e1; margin: 0 0 16px 0; font-size: 14px;">Verify your identity to activate your account:</p>
                <div style="font-size: 36px; font-weight: bold; letter-spacing: 8px; color: #00e676; background: rgba(0,230,118,0.1); border: 2px dashed rgba(0,230,118,0.3); border-radius: 12px; padding: 16px; font-family: 'Courier New', monospace;">
                    ${code}
                </div>
            ...
            <p style="color: #64748b; font-size: 12px; text-align: center; margin: 0;">
                If you did not sign up for AntiGrav, please ignore this email.
            </p>
        </div>`;
